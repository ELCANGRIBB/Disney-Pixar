      ...
      <div className="relative z-10 flex flex-col min-h-screen px-4 py-6">
        ...
        <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 text-sm">Registrate para comenzar</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-4 rounded-2xl text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-amber-500"
                style={{
                  background: 'rgba(255, 255, 255, 0.02)',
                  border: '1px solid rgba(255, 193, 7, 0.2)',
                }}
          ...
          <p className="text-center text-gray-500 text-sm mt-6">
            Ya tienes cuenta?{' '}
            <Link to="/login" className="font-semibold" style={{ color: '#FFC107' }}>
              Inicia Sesion
            </Link>
          </p>
        </div>
